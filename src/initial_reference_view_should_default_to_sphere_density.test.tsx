...
describe("Initial reference view", () => {
  it("initial reference view should default to sphere density", () => {
    ...
    expect(screen.getByRole("button", { name: /^density$/i })).toHaveAttribute(
      "aria-pressed",
      "true",
    );
    expect(screen.getByRole("button", { name: /particles/i })).not.toBeDisabled();
  });
});
